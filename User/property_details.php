            ...
            <div class="container ">
                <div class="row text-center ">
                    <div class="col-12 ">
                        ...
                        <div id="carouselExampleIndicators" class="img-fluid carousel slide h-50">
                            ...
                            <button class="carousel-control-prev t" type="button"
                ...
                <!-- <div class=" row container">
                    <div class="col-12 mt-4" style="width: 100%;">
                        <h4 class="animated text-black fadeIn mb-3" style="border-bottom: 2px solid var(--tan);"> Review
                            Rating</h4>
