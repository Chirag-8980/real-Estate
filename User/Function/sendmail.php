...
//echo "Email send successfully!!";
    ...
    //         include_once('C:\xampp\htdocs\git-main\real-Estate\User\Function\tcpdf\tcpdf.php');
    ...
    //         $file_location = "../../admin/upload/PDF"; //add your full path of your server
    //         //$file_location = "/opt/lampp/htdocs/examples/generate_pdf/uploads/"; //for local xampp server
    //         $datetime=date('dmY_hms');
    //         $file_name = "INV_".$datetime.".pdf";
    //         ob_end_clean();
    ...
    //         $mail->From = "locus466@gmail.com";
    //         $mail->FromName = "pknpemzpfomyiyrz";
    //         $mail->IsHTML(true);
    //         $mail->setFrom('locus466@gmail.com');
    //         $mail->AddAddress($email);
