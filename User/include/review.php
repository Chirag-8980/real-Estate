...
<body>
    ...
    <div class="mt-5">
            <div class="row g-3">
                ...
                <div class="col-12">
                    <button class="btn bg-tan text-black w-100 py-3" id="save_review" name="submit" type="submit">Submit</button>
                </div>
            </div>
    </div>
...
<!-- <div id="review_modal" class="modal modal-dialog modal-dialog-centered" tabindex="-1" role="dialog">
