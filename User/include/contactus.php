    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center text-black mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                ...
                <h1 class="mb-3 text-black">Contact Us</h1>
            ...
            <div class="row g-4">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                            <div class="bgcolor rounded p-3">
                                <div class="d-flex align-items-center bg-white text-black rounded p-3"
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                            <div class="bgcolor rounded p-3">
                                <div class="d-flex text-black align-items-center bg-white rounded p-3"
                                    style="border: 1px dashed var(--tan)">
                ...
                <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7438.6242865312515!2d72.89836772411462!3d21.21946734358138!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be045882435e545%3A0xd6f93d3d2fa5d1b5!2sSimada%20Gam%2C%20Nana%20Varachha%2C%20Surat%2C%20Gujarat%20395006!5e0!3m2!1sen!2sin!4v1677499400853!5m2!1sen!2sin"
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <form action="contact.php" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn bg-tan text-black w-100 py-3" name="submit" type="submit">Send
                                        Message</button>
                                </div>
                            </div>
                        </form>
