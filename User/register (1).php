                    ...
                    <form action="function/authcode.php" onsubmit="return validateForm()" id="myForm" method="post">
                        <div class="input-boxes">
                            <div class="input-box">
                                ...
                                <input type="text" name="uname" id="uname" placeholder="Enter your name" oninvalid="setCustomValidity('Please enter a valid name')" onblur="setCustomValidity('')" oninput="validateName()">
                            </div>
                            <div class="text-danger" id="error-name"></div>
                            <div class="input-box">
                                <i class="fas fa-envelope"></i>
                                <input type="text" name="email" id="email" placeholder="Enter your email" oninvalid="setCustomValidity('Please enter a valid Email ID')" onblur="setCustomValidity('')" oninput="validateEmail()">
                            </div>
                            <div class="text-danger" id="error-email"></div>
                            <div class="input-box">
                                <i class="fa fa-phone"></i>
                                <input type="text" name="mno" id="mno" placeholder="Enter your phone number" oninvalid="setCustomValidity('Please enter a valid 10-digit phone number')" onblur="setCustomValidity('')" oninput="validateMobile()">
                            </div>
                            <div class="text-danger" id="error-mobile"></div>

                            <div class="input-box">
                                <i class="fas fa-lock"></i>
                                <input type="password" name="password" id="password" minlength="8" placeholder="Enter your password" oninvalid="setCustomValidity('Please enter Password')" onblur="setCustomValidity('')" oninput="validatePassword()">
                            </div>
                            <div class="text-danger" id="password-error"></div>
                            <div class="input-box">
                                <i class="fas fa-lock"></i>
                                <input type="password" name="cpassword" minlength="8" id="cpassword" placeholder="Enter your Confrim password" oninvalid="setCustomValidity('Please enter Confirm Password')" onblur="setCustomValidity('')" oninput="confirmPassword()">
                            </div>
                            ...
                            <div class="text sign-up-text">Already have an account? <a style="color: #E0A96D;" href="login.php">Login Now</a>
                            </div>
                        </div>
                    </form>
