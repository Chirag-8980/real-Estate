              ...
              ?>
                    <form action="function/authcode.php" method="post">
                        <div class="input-boxes">
                            ...
                            <div class="input-box">
                                <i class="fa-solid fa-lock"></i>
                                <input type="text" name="ncpass" placeholder="Confirm password" required>
                            </div>
                            <div class="button input-box">
                                <input type="submit" name="reset_btn" value="Reset Password">
                            </div>
                            <div class="text sign-up-text">Already have an account? <label><a style="color: #E0A96D;"
                                        href="login.php"> Login now</a></label></div>
                        </div>
                    </form>
                </div>
            </div>
