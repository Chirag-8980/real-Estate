<?php
    ...
    if(isset($_POST['QC'])){
        ...
        $destination1="../admin/img/property_image/business".$image1;
        ...
        $destination2="../admin/img/property_image/business".$image2;
        ...
        $destination3="../admin/img/property_image/business".$image3;
        ...
        $destination4="../admin/img/property_image/business".$image4;
        ...
        if(in_array($img_type1 || $img_type2 || $img_type3 || $img_type4, $allow_type))
        {
            if($size <= 2000000)
            {
                ...
                $insert_qry = "INSERT INTO `tblbusiness`(`uid`, `ptitle`, `paddress`, `state`, `city`, `price`, `sqft`, `rooms`, `stype`, `img1`, `img2`, `img3`, `img4`, `facilities`, `description`) VALUES ('$uid','$ptitle','$paddress','$state','$city','$price','$sqft','$rooms','$stype','$image1','$image2','$image3','$image4','$facilities','$description')";
...
<body>
    <div class=" bg-white p-0">
        ...
        <div class="container mt-3 px-5">
            <form class="row g-3 container" method="POST" action="addbusiness.php" enctype="multipart/form-data">
                <!-- Basic Information -->
                ...
                <div class="col-md-6 input-group-lg">
                    <label for="inputZip" class="form-label  text-black">Total Rooms</label>
                    <input type="text" name="rooms" class="form-control" id="inputZip" placeholder="Enter total room">
                </div>
