...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2023 at 01:47 PM
...
(42, 'Jaimil', 126, 43, 44, 'jaimilkanejeeya630@gmail.com', '2023-04-10', '2023-05-11', '2023-04-10', 'Success', 'I Want This Property For Rent', 'Ok'),
(43, 'Jaimil', 124, 43, 44, 'jaimilkanejeeya630@gmail.com', '', '', '2023-04-10', 'Reject', 'I Want this property', 'Deal Cancel');
...
(4, 'Gold', 500, 8, '<p>This Is Gold Plan</p>', '2023-04-01'),
...
(25, 43, 4, 'Paid', 'pay_Lc41RGAhMXmVgA', 500, '2023-04-10 10:58:40', 'Gold');
...
(43, 'Chirag', '8980750691', 'chiragkachhadiya000@gmail.com', '$2y$10$gaxyF1tQ.kB6m4MeE.VsF.1GDgbR216B4RRXMtbtKUO.g2wM3ek5a', 'Pending', '49 MD Park Socity Simada Gam', 'instagram', 'facebook', 'twitter', 7),
(44, 'Jaimil', '8238378852', 'jaimilkanejeeya630@gmail.com', '$2y$10$kbhY84ZSGWLwSH0.KlNR1Oqa6NQCUTsQsne7MTQhv54y0GeJu414m', 'Pending', 'sdfgh', 'instagram', 'facebook', 'twitter', 3);
...
--
ALTER TABLE `tblpbooking`
  MODIFY `bid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `tblpmt`
  MODIFY `pmid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
