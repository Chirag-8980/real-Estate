<?php
    ...
    if(isset($_POST['QC'])){
        ...
        $destination1="../admin/img/property_image/occasion".$image1;
        ...
        $destination2="../admin/img/property_image/occasion".$image2;
        ...
        $destination3="../admin/img/property_image/occasion".$image3;
        ...
        $destination4="../admin/img/property_image/occasion".$image4;
        ...
        if(in_array($img_type1 || $img_type2 || $img_type3 || $img_type4, $allow_type))
        {
            if($size <= 2000000)
            {
                ...
                $insert_qry = "INSERT INTO `tbloccasion`(`cid`,`uid`, `ptitle`, `capacity`, `paddress`, `state`, `city`, `price`, `sqft`, `stype`, `img1`, `img2`, `img3`, `img4`, `facilities`, `description`) VALUES ('$cid','$uid','$ptitle','$capacity','$paddress','$state','$city','$price','$sqft','$stype','$image1','$image2','$image3','$image4','$facilities','$description')";
...
<body>
    <div class=" bg-white p-0">
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated text-black fadeIn mb-4">Add Business Property</h1>
                    <nav aria-label="breadcrumb animated fadeIn">
                        <ol class="breadcrumb text-uppercase">
                            ...
                            <li class="breadcrumb-item text-body text-black active" aria-current="page">Business
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container mt-3 px-5">
            <form class="row g-3 container" method="POST" action="addoccasion.php?cid=3" enctype="multipart/form-data">
                <!-- Basic Information -->
                ...
                <div class="col-md-6 input-group-lg">
                    <label for="inputZip" class="form-label  text-black">People Capacity</label>
                    <input type="text" name="capacity" class="form-control" id="inputZip" placeholder="People Capacity">
                </div>
                ...
                <div class="col-md-6 input-group-lg">
                    <label for="inputState" class="form-label text-black" hidden>Status</label>
