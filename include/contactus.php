                ...
                <div class="row g-4">
                                ...
                                <div class="bgcolor rounded p-3">
                                    <div class="d-flex align-items-center bg-white text-black rounded p-3" style="border: 1px dashed var(--tan)">
                                        <div class="icon icon1 me-3" style="width: 45px; height: 45px;">
                                            <i class="fa text-black btn-social fa-map-marker-alt"></i>
                                        </div>
                                ...
                                <div class="bgcolor rounded p-3">
                                    <div class="d-flex text-black align-items-center bg-white rounded p-3" style="border: 1px dashed var(--tan)">
                                        <div class="icon  me-3" style="width: 45px; height: 45px;">
                                            <i class="fa fa-envelope-open text-black"></i>
                                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form action="https://formspree.io/f/myyawllv" method="post">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <button class="btn bg-tan text-black w-100 py-3" type="submit">Send Message</button>
                                    </div>
                                </div>
                            </form>
                        </div>
